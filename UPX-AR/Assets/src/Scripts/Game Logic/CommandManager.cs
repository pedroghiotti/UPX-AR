    ...
    */
    ...
    public async void Execute()
    {
        ...
        */
        ...
        Cmd_Queue queue = (Cmd_Queue) ScriptableObject.CreateInstance(typeof(Cmd_Queue));
        queue.Initialize(tracked.OrderBy(obj => obj.transform.position.x).Select(obj => obj.GetComponent<Command>().commandData).ToList());
